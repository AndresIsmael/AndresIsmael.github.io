...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(datosService) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.datosService.getDatos()
            .subscribe(function (resp) { return _this.datos = resp; });
    };
...
var SingleComponent = /** @class */ (function () {
    function SingleComponent(datosService, route) {
        this.datosService = datosService;
        this.route = route;
    ...
    SingleComponent.ctorParameters = function () { return [
        { type: _services_datos_service__WEBPACK_IMPORTED_MODULE_2__["DatosService"] },
...
var DatosService = /** @class */ (function () {
    ...
    DatosService.prototype.getDt = function (id) {
        return this.http.get(this.url + "/" + id);
    };
    DatosService.prototype.getComments = function (id) {
    ...
    DatosService.prototype.crearArreglo = function (datosObject) {
        return datosObject;
    };
    DatosService.ctorParameters = function () { return [
